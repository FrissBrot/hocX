...
from app.api.routes import admin, admin_auth, auth, collaboration_ws, cycle_configs, document_templates, events, exports, files, finance, fines, lists, participants, protocol_elements, protocols, songbooks, statistics, submission_assignments, tag_config, templates, tenants, todos, users
...
app.include_router(songbooks.router, prefix="/api", tags=["songbooks"])
