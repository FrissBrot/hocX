...
from app.api.routes import admin, admin_auth, auth, collaboration_ws, cycle_configs, document_templates, events, exports, files, finance, fines, lists, participants, protocol_elements, protocols, statistics, submission_assignments, table_snapshots, tag_config, templates, tenants, todos, users, word_import
