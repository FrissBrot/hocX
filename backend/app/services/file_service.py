...
from app.services.upload_pipeline import (
    ...
    GALLERY_DIRECT_IMAGE_MAX_BYTES,
    GalleryZipClip,
    MAX_UPLOAD_BYTES,
    MAX_ZIP_TOTAL_BYTES,
    PDF_MIME_TYPE,
        ...
        for (filename, content), scan_status in zip(files, scan_statuses):
            ...
            try:
                result = ingest_file(
                    ...
                    max_bytes=GALLERY_DIRECT_IMAGE_MAX_BYTES,
                    ...
                    too_large_message=f"zu gross (maximal {GALLERY_DIRECT_IMAGE_MAX_BYTES // 1024 // 1024} MB)",
